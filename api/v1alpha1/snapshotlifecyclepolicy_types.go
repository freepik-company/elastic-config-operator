...
type SnapshotLifecyclePolicyStatus struct {
	...
	// Phase represents the current phase of the SnapshotLifecyclePolicy
	...
	// conditions represent the current state of the SnapshotLifecyclePolicy resource.
...
type SnapshotLifecyclePolicy struct {
	...
	// spec defines the desired state of SnapshotLifecyclePolicy
	// +required
	Spec SnapshotLifecyclePolicySpec `json:"spec"`

	// status defines the observed state of SnapshotLifecyclePolicy
	// +optional
	Status SnapshotLifecyclePolicyStatus `json:"status,omitzero"`
}
