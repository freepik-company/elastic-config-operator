...
// +kubebuilder:rbac:groups=elastic-config-operator.freepik.com,resources=indexstatemanagements,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=elastic-config-operator.freepik.com,resources=indexstatemanagements/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=elastic-config-operator.freepik.com,resources=indexstatemanagements/finalizers,verbs=update
