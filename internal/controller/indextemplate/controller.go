...
// +kubebuilder:rbac:groups=eck-config-operator.freepik.com,resources=indextemplates,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=eck-config-operator.freepik.com,resources=indextemplates/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=eck-config-operator.freepik.com,resources=indextemplates/finalizers,verbs=update
